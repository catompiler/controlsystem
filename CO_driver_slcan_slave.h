...
typedef struct {
    ...
    CO_CANrx_slcan_slave_t* rxArray;             /**< From CO_CANmodule_init() */
    uint16_t rxSize;                 /**< From CO_CANmodule_init() */
    CO_CANtx_slcan_slave_t* txArray;             /**< From CO_CANmodule_init() */
 ...
 */
void
CO_CANinterrupt_slcan_slave(CO_CANmodule_slcan_slave_t* CANmodule);
