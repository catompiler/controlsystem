...
struct _S_Adc {
    ...
    reg_iq24_t out_Ua; //!< Мнговенное напряжение фазы A. @{"base":"conf.r_U_base"}
    reg_iq24_t out_Ub; //!< Мнговенное напряжение фазы B. @{"base":"conf.r_U_base"}
    reg_iq24_t out_Uc; //!< Мнговенное напряжение фазы C. @{"base":"conf.r_U_base"}
    // Токи сети.
    ...
    reg_iq24_t out_Ia; //!< Мнговенный ток фазы A. @{"base":"conf.r_I_base"}
    reg_iq24_t out_Ib; //!< Мнговенный ток фазы B. @{"base":"conf.r_I_base"}
    reg_iq24_t out_Ic; //!< Мнговенный ток фазы C. @{"base":"conf.r_I_base"}
    // Напряжение выхода.
    reg_u32_t out_Uarm_raw; //!< Мнговенное напряжение выхода (сырое).
    reg_iq24_t out_Uarm; //!< Мнговенное напряжение выхода. @{"base":"motor.r_r_U_base"}
    // Ток выхода.
    reg_u32_t out_Iarm_raw; //!< Мнговенный ток выхода (сырое).
    reg_iq24_t out_Iarm; //!< Мнговенный ток выхода. @{"base":"motor.r_r_I_base"}
    // Ток резистора.
    reg_u32_t out_Ir_raw; //!< Мнговенный ток резистора (сырое).
    reg_iq24_t out_Irstart; //!< Мнговенный ток резистора. @{"base":"motor.r_r_I_base"}
    // Напряжения статора.
    ...
    reg_iq24_t out_s_Ua; //!< Мнговенное напряжение фазы A статора. @{"base":"motor.r_s_U_base"}
    reg_iq24_t out_s_Ub; //!< Мнговенное напряжение фазы B статора. @{"base":"motor.r_s_U_base"}
    reg_iq24_t out_s_Uc; //!< Мнговенное напряжение фазы C статора. @{"base":"motor.r_s_U_base"}
    // Токи статора.
    ...
    reg_iq24_t out_s_Ia; //!< Мнговенный ток фазы A статора. @{"base":"motor.r_s_I_base"}
    reg_iq24_t out_s_Ib; //!< Мнговенный ток фазы B статора. @{"base":"motor.r_s_I_base"}
    reg_iq24_t out_s_Ic; //!< Мнговенный ток фазы C статора. @{"base":"motor.r_s_I_base"}
    // Параметры.
    // Напряжения сети.
