...
#define OD_ENTRY_H2530_or_value_slip_lt_zero_i_r_sync &OD->list[117]
#define OD_ENTRY_H2540_and_ready_to_exc &OD->list[118]
#define OD_ENTRY_H2550_tmr_field_on_rstart_off &OD->list[119]
#define OD_ENTRY_H2560_not_ready_to_exc &OD->list[120]
#define OD_ENTRY_H2570_cmp_ctrl_state_is_start &OD->list[121]
#define OD_ENTRY_H2580_and_rstart_on &OD->list[122]
#define OD_ENTRY_H2590_thr_field_supp_i_r &OD->list[123]
#define OD_ENTRY_H25A0_tmr_field_supp &OD->list[124]
#define OD_ENTRY_H25B0_cnt_start &OD->list[125]
#define OD_ENTRY_H25C0_filter_zcd_ua &OD->list[126]
#define OD_ENTRY_H25D0_filter_zcd_ub &OD->list[127]
#define OD_ENTRY_H25E0_filter_zcd_uc &OD->list[128]
#define OD_ENTRY_H25F0_filter_zcd_slip &OD->list[129]
#define OD_ENTRY_H2600_filter_freq_ua &OD->list[130]
#define OD_ENTRY_H2610_filter_freq_ub &OD->list[131]
#define OD_ENTRY_H2620_filter_freq_uc &OD->list[132]
#define OD_ENTRY_H2630_filter_freq_slip &OD->list[133]
#define OD_ENTRY_H2640_filter_mean_iarm &OD->list[134]
#define OD_ENTRY_H2650_filter_mean_uarm &OD->list[135]
#define OD_ENTRY_H2660_filter_mean_irstart &OD->list[136]
#define OD_ENTRY_H2670_tmr_start_min_forcing &OD->list[137]
#define OD_ENTRY_H2680_tmr_start_max_forcing &OD->list[138]
#define OD_ENTRY_H2690_tmr_start_stab_forcing &OD->list[139]
#define OD_ENTRY_H26A0_thr_start_q_le_zero &OD->list[140]
#define OD_ENTRY_H26B0_and_start_min_forcing_end &OD->list[141]
#define OD_ENTRY_H26C0_or_start_forcing_end &OD->list[142]
#define OD_ENTRY_H26D0_mux_field_regs &OD->list[143]
#define OD_ENTRY_H26E0_lim_field_regs_curr_ref &OD->list[144]
#define OD_ENTRY_H26F0_mux_field_force_ref &OD->list[145]
#define OD_ENTRY_H2700_mot_pot_field_test &OD->list[146]
#define OD_ENTRY_H2710_mot_pot_manual_curr_ref &OD->list[147]
#define OD_ENTRY_H2720_mux_curr_ref &OD->list[148]
#define OD_ENTRY_H2730_pid_i &OD->list[149]
#define OD_ENTRY_H2740_pid_coefs_i &OD->list[150]
#define OD_ENTRY_H2750_ph3c &OD->list[151]
#define OD_ENTRY_H2760_triacs &OD->list[152]
#define OD_ENTRY_H2770_lrm &OD->list[153]
#define OD_ENTRY_H2780_motor &OD->list[154]
#define OD_ENTRY_H2790_prot &OD->list[155]
#define OD_ENTRY_H27A0_canopen &OD->list[156]
#define OD_ENTRY_H27B0_storage &OD->list[157]
#define OD_ENTRY_H27C0_settings &OD->list[158]
