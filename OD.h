...
#define OD_ENTRY_H2780 &OD->list[154]
#define OD_ENTRY_H2790 &OD->list[155]
#define OD_ENTRY_H27A0 &OD->list[156]
#define OD_ENTRY_H27B0 &OD->list[157]
#define OD_ENTRY_H27C0 &OD->list[158]
#define OD_ENTRY_H27D0 &OD->list[159]
...
#define OD_ENTRY_H2430_thr_run_trig_i_s &OD->list[101]
#define OD_ENTRY_H2440_am_run_trig_i_s &OD->list[102]
#define OD_ENTRY_H2450_mux_run_trig &OD->list[103]
...
#define OD_ENTRY_H24F0_or_field_on &OD->list[113]
#define OD_ENTRY_H2500_tmr_field_on &OD->list[114]
#define OD_ENTRY_H2510_thr_value_for_slip_lt_zero &OD->list[115]
#define OD_ENTRY_H2520_or_value_slip_lt_zero_i_r_sync &OD->list[116]
#define OD_ENTRY_H2530_and_ready_to_exc &OD->list[117]
#define OD_ENTRY_H2540_tmr_field_on_rstart_off &OD->list[118]
#define OD_ENTRY_H2550_not_ready_to_exc &OD->list[119]
#define OD_ENTRY_H2560_cmp_ctrl_state_is_start &OD->list[120]
#define OD_ENTRY_H2570_and_rstart_on &OD->list[121]
#define OD_ENTRY_H2580_thr_field_on_i_r_sync &OD->list[122]
#define OD_ENTRY_H2590_tmr_field_on_i_r_sync &OD->list[123]
#define OD_ENTRY_H25A0_thr_field_supp_i_r &OD->list[124]
#define OD_ENTRY_H25B0_tmr_field_supp &OD->list[125]
#define OD_ENTRY_H25C0_cnt_start &OD->list[126]
#define OD_ENTRY_H25D0_filter_zcd_ua &OD->list[127]
#define OD_ENTRY_H25E0_filter_zcd_ub &OD->list[128]
#define OD_ENTRY_H25F0_filter_zcd_uc &OD->list[129]
#define OD_ENTRY_H2600_filter_zcd_slip &OD->list[130]
#define OD_ENTRY_H2610_filter_freq_ua &OD->list[131]
#define OD_ENTRY_H2620_filter_freq_ub &OD->list[132]
#define OD_ENTRY_H2630_filter_freq_uc &OD->list[133]
#define OD_ENTRY_H2640_filter_freq_slip &OD->list[134]
#define OD_ENTRY_H2650_filter_mean_iarm &OD->list[135]
#define OD_ENTRY_H2660_filter_mean_uarm &OD->list[136]
#define OD_ENTRY_H2670_filter_mean_irstart &OD->list[137]
#define OD_ENTRY_H2680_tmr_start_min_forcing &OD->list[138]
#define OD_ENTRY_H2690_tmr_start_max_forcing &OD->list[139]
#define OD_ENTRY_H26A0_tmr_start_stab_forcing &OD->list[140]
#define OD_ENTRY_H26B0_thr_start_q_le_zero &OD->list[141]
#define OD_ENTRY_H26C0_and_start_min_forcing_end &OD->list[142]
#define OD_ENTRY_H26D0_or_start_forcing_end &OD->list[143]
#define OD_ENTRY_H26E0_mux_field_regs &OD->list[144]
#define OD_ENTRY_H26F0_lim_field_regs_curr_ref &OD->list[145]
#define OD_ENTRY_H2700_mux_field_force_ref &OD->list[146]
#define OD_ENTRY_H2710_mot_pot_field_test &OD->list[147]
#define OD_ENTRY_H2720_mot_pot_manual_curr_ref &OD->list[148]
#define OD_ENTRY_H2730_mux_curr_ref &OD->list[149]
#define OD_ENTRY_H2740_pid_i &OD->list[150]
#define OD_ENTRY_H2750_pid_coefs_i &OD->list[151]
#define OD_ENTRY_H2760_ph3c &OD->list[152]
#define OD_ENTRY_H2770_triacs &OD->list[153]
#define OD_ENTRY_H2780_lrm &OD->list[154]
#define OD_ENTRY_H2790_motor &OD->list[155]
#define OD_ENTRY_H27A0_prot &OD->list[156]
#define OD_ENTRY_H27B0_canopen &OD->list[157]
#define OD_ENTRY_H27C0_storage &OD->list[158]
#define OD_ENTRY_H27D0_settings &OD->list[159]
