...
typedef struct {
    ...
    OD_obj_record_t o_2020_sys_ctrl[14];
    ...
    OD_obj_record_t o_20E0_dlog[55];
    ...
    OD_obj_record_t o_2430_field_trig[8];
    ...
    OD_obj_record_t o_2500_thr_field_on_i_r_sync[6];
    OD_obj_record_t o_2510_tmr_field_on_i_r_sync[10];
    OD_obj_record_t o_2520_thr_value_for_slip_lt_zero[6];
    OD_obj_record_t o_2530_tmr_field_on_rstart_off[10];
    OD_obj_record_t o_2540_tmr_start_min_forcing[6];
    OD_obj_record_t o_2550_tmr_start_max_forcing[6];
    OD_obj_record_t o_2560_tmr_start_stab_forcing[10];
    OD_obj_record_t o_2570_thr_start_q_le_zero[6];
    OD_obj_record_t o_2580_thr_field_supp_i_r[6];
    OD_obj_record_t o_2590_tmr_field_supp[6];
    OD_obj_record_t o_25A0_cnt_start[4];
    OD_obj_record_t o_25B0_filter_zcd_ua[7];
    OD_obj_record_t o_25C0_filter_zcd_ub[7];
    OD_obj_record_t o_25D0_filter_zcd_uc[7];
    OD_obj_record_t o_25E0_filter_zcd_slip[7];
    OD_obj_record_t o_25F0_filter_freq_ua[7];
    OD_obj_record_t o_2600_filter_freq_ub[7];
    OD_obj_record_t o_2610_filter_freq_uc[7];
    OD_obj_record_t o_2620_filter_freq_slip[7];
    OD_obj_record_t o_2630_filter_mean_iarm[7];
    OD_obj_record_t o_2640_filter_mean_uarm[7];
    OD_obj_record_t o_2650_filter_mean_irstart[7];
    OD_obj_record_t o_2660_mux_field_regs[9];
    OD_obj_record_t o_2670_lim_field_regs_curr_ref[7];
    OD_obj_record_t o_2680_mux_field_force_ref[7];
    OD_obj_record_t o_2690_mot_pot_field_test[10];
    OD_obj_record_t o_26A0_mot_pot_manual_curr_ref[10];
    OD_obj_record_t o_26B0_mux_curr_ref[9];
    OD_obj_record_t o_26C0_pid_i[12];
    OD_obj_record_t o_26D0_pid_coefs_i[12];
    OD_obj_record_t o_26E0_ph3c[97];
    OD_obj_record_t o_26F0_triacs[11];
    OD_obj_record_t o_2700_lrm[53];
    OD_obj_record_t o_2710_motor[43];
    OD_obj_record_t o_2720_prot[97];
    OD_obj_record_t o_2730_canopen[3];
    OD_obj_record_t o_2740_storage[3];
    OD_obj_record_t o_2750_settings[4];
    OD_obj_record_t o_2760_event_log[43];
    OD_obj_record_t o_2770_oscope[38];
} ODObjs_t;
...
.o_2020_sys_ctrl = {
    ...
    {
    .dataOrig = &sys_ctrl.p_init_run_current_ref,
    .subIndex = 8,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &sys_ctrl.p_forcing_current,
    .subIndex = 9,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
...
.o_2430_field_trig = {
    {
    .dataOrig = &regs_data.field_trig.count,
    .subIndex = 0,
    .attribute = ODA_SDO_R,
    .dataLength = 1
    },
    {
    .dataOrig = &field_trig.control,
    .subIndex = 1,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.status,
    .subIndex = 2,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.out_run,
    .subIndex = 3,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.out_field_on,
    .subIndex = 4,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.out_rstart_on,
    .subIndex = 5,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.out_start_forcing_end,
    .subIndex = 6,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &field_trig.out_field_supp_end,
    .subIndex = 7,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    }
...
.o_2520_thr_value_for_slip_lt_zero = {
    {
...
.o_2670_lim_field_regs_curr_ref = {
    {
...
.o_26A0_mot_pot_manual_curr_ref = {
    {
...
.o_2720_prot = {
    ...
    {
    .dataOrig = &prot.out_has_warnings,
    .subIndex = 11,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &prot.out_warning_occured,
    .subIndex = 12,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &prot.p_mains_lost_enabled,
    .subIndex = 13,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_mains_invalid_enabled,
    .subIndex = 15,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_mains_undervoltage_enabled,
    .subIndex = 18,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_mains_overvoltage_enabled,
    .subIndex = 20,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_mains_overcurrent_enabled,
    .subIndex = 22,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_overvoltage_enabled,
    .subIndex = 24,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    ...
    {
    .dataOrig = &prot.p_overcurrent_enabled,
    .subIndex = 26,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
...
.o_2760_event_log = {
    {
    .dataOrig = &regs_data.event_log.count,
    .subIndex = 0,
    .attribute = ODA_SDO_R,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.control,
    .subIndex = 1,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.status,
    .subIndex = 2,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.in_event_type,
    .subIndex = 3,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.in_event_n,
    .subIndex = 4,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.in_osc_ch_n,
    .subIndex = 5,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.header.magic,
    .subIndex = 6,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.header.index,
    .subIndex = 7,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.header.type,
    .subIndex = 8,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.header.reserved0[0],
    .subIndex = 9,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.header.reserved0[1],
    .subIndex = 10,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.header.reserved0[2],
    .subIndex = 11,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.header.crc,
    .subIndex = 12,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_event_data.info.time,
    .subIndex = 13,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.error0,
    .subIndex = 14,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.error1,
    .subIndex = 15,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.error2,
    .subIndex = 16,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_error0,
    .subIndex = 17,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_error1,
    .subIndex = 18,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_error2,
    .subIndex = 19,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.warning0,
    .subIndex = 20,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.warning1,
    .subIndex = 21,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.warning2,
    .subIndex = 22,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_warning0,
    .subIndex = 23,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_warning1,
    .subIndex = 24,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.reg_warning2,
    .subIndex = 25,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.din,
    .subIndex = 26,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.dout,
    .subIndex = 27,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.info.crc,
    .subIndex = 28,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.Fs,
    .subIndex = 29,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.channels_count,
    .subIndex = 30,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.reserved0[0],
    .subIndex = 31,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.reserved0[1],
    .subIndex = 32,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.reserved0[2],
    .subIndex = 33,
    .attribute = ODA_SDO_RW,
    .dataLength = 1
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.samples_count,
    .subIndex = 34,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.event_sample,
    .subIndex = 35,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_event_data.osc_info.crc,
    .subIndex = 36,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.info.reg_id,
    .subIndex = 37,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.info.offset,
    .subIndex = 38,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.info.gain,
    .subIndex = 39,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.info.crc,
    .subIndex = 40,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.data.samples[0],
    .subIndex = 41,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 480
    },
    {
    .dataOrig = &event_log.r_osc_channel_data.channel.data.crc,
    .subIndex = 42,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 2
    }
...
.o_2770_oscope = {
    {
    .dataOrig = &regs_data.oscope.count,
    .subIndex = 0,
    .attribute = ODA_SDO_R,
    .dataLength = 1
    },
    {
    .dataOrig = &oscope.control,
    .subIndex = 1,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.status,
    .subIndex = 2,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_samples,
    .subIndex = 3,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_prescaler,
    .subIndex = 4,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_hist_samples,
    .subIndex = 5,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[0].reg_id,
    .subIndex = 6,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[0].enabled,
    .subIndex = 7,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[1].reg_id,
    .subIndex = 8,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[1].enabled,
    .subIndex = 9,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[2].reg_id,
    .subIndex = 10,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[2].enabled,
    .subIndex = 11,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[3].reg_id,
    .subIndex = 12,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[3].enabled,
    .subIndex = 13,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[4].reg_id,
    .subIndex = 14,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[4].enabled,
    .subIndex = 15,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[5].reg_id,
    .subIndex = 16,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[5].enabled,
    .subIndex = 17,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[6].reg_id,
    .subIndex = 18,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[6].enabled,
    .subIndex = 19,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[7].reg_id,
    .subIndex = 20,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch[7].enabled,
    .subIndex = 21,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_ch_data[0].samples[0],
    .subIndex = 22,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[1].samples[0],
    .subIndex = 23,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[2].samples[0],
    .subIndex = 24,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[3].samples[0],
    .subIndex = 25,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[4].samples[0],
    .subIndex = 26,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[5].samples[0],
    .subIndex = 27,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[6].samples[0],
    .subIndex = 28,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_ch_data[7].samples[0],
    .subIndex = 29,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 1024
    },
    {
    .dataOrig = &oscope.r_mode,
    .subIndex = 30,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_trig.enabled,
    .subIndex = 31,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_trig.ch_n,
    .subIndex = 32,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_trig.type,
    .subIndex = 33,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_trig.value,
    .subIndex = 34,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_start,
    .subIndex = 35,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_index,
    .subIndex = 36,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    },
    {
    .dataOrig = &oscope.r_count,
    .subIndex = 37,
    .attribute = ODA_SDO_RW | ODA_MB,
    .dataLength = 4
    }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2020, 0x0e, ODT_REC, &ODObjs.o_2020_sys_ctrl, NULL},
    ...
    {0x20e0, 0x37, ODT_REC, &ODObjs.o_20E0_dlog, NULL},
    ...
    {0x2430, 0x08, ODT_REC, &ODObjs.o_2430_field_trig, NULL},
    ...
    {0x2500, 0x06, ODT_REC, &ODObjs.o_2500_thr_field_on_i_r_sync, NULL},
    {0x2510, 0x0a, ODT_REC, &ODObjs.o_2510_tmr_field_on_i_r_sync, NULL},
    {0x2520, 0x06, ODT_REC, &ODObjs.o_2520_thr_value_for_slip_lt_zero, NULL},
    {0x2530, 0x0a, ODT_REC, &ODObjs.o_2530_tmr_field_on_rstart_off, NULL},
    {0x2540, 0x06, ODT_REC, &ODObjs.o_2540_tmr_start_min_forcing, NULL},
    {0x2550, 0x06, ODT_REC, &ODObjs.o_2550_tmr_start_max_forcing, NULL},
    {0x2560, 0x0a, ODT_REC, &ODObjs.o_2560_tmr_start_stab_forcing, NULL},
    {0x2570, 0x06, ODT_REC, &ODObjs.o_2570_thr_start_q_le_zero, NULL},
    {0x2580, 0x06, ODT_REC, &ODObjs.o_2580_thr_field_supp_i_r, NULL},
    {0x2590, 0x06, ODT_REC, &ODObjs.o_2590_tmr_field_supp, NULL},
    {0x25a0, 0x04, ODT_REC, &ODObjs.o_25A0_cnt_start, NULL},
    {0x25b0, 0x07, ODT_REC, &ODObjs.o_25B0_filter_zcd_ua, NULL},
    {0x25c0, 0x07, ODT_REC, &ODObjs.o_25C0_filter_zcd_ub, NULL},
    {0x25d0, 0x07, ODT_REC, &ODObjs.o_25D0_filter_zcd_uc, NULL},
    {0x25e0, 0x07, ODT_REC, &ODObjs.o_25E0_filter_zcd_slip, NULL},
    {0x25f0, 0x07, ODT_REC, &ODObjs.o_25F0_filter_freq_ua, NULL},
    {0x2600, 0x07, ODT_REC, &ODObjs.o_2600_filter_freq_ub, NULL},
    {0x2610, 0x07, ODT_REC, &ODObjs.o_2610_filter_freq_uc, NULL},
    {0x2620, 0x07, ODT_REC, &ODObjs.o_2620_filter_freq_slip, NULL},
    {0x2630, 0x07, ODT_REC, &ODObjs.o_2630_filter_mean_iarm, NULL},
    {0x2640, 0x07, ODT_REC, &ODObjs.o_2640_filter_mean_uarm, NULL},
    {0x2650, 0x07, ODT_REC, &ODObjs.o_2650_filter_mean_irstart, NULL},
    {0x2660, 0x09, ODT_REC, &ODObjs.o_2660_mux_field_regs, NULL},
    {0x2670, 0x07, ODT_REC, &ODObjs.o_2670_lim_field_regs_curr_ref, NULL},
    {0x2680, 0x07, ODT_REC, &ODObjs.o_2680_mux_field_force_ref, NULL},
    {0x2690, 0x0a, ODT_REC, &ODObjs.o_2690_mot_pot_field_test, NULL},
    {0x26a0, 0x0a, ODT_REC, &ODObjs.o_26A0_mot_pot_manual_curr_ref, NULL},
    {0x26b0, 0x09, ODT_REC, &ODObjs.o_26B0_mux_curr_ref, NULL},
    {0x26c0, 0x0c, ODT_REC, &ODObjs.o_26C0_pid_i, NULL},
    {0x26d0, 0x0c, ODT_REC, &ODObjs.o_26D0_pid_coefs_i, NULL},
    {0x26e0, 0x61, ODT_REC, &ODObjs.o_26E0_ph3c, NULL},
    {0x26f0, 0x0b, ODT_REC, &ODObjs.o_26F0_triacs, NULL},
    {0x2700, 0x35, ODT_REC, &ODObjs.o_2700_lrm, NULL},
    {0x2710, 0x2b, ODT_REC, &ODObjs.o_2710_motor, NULL},
    {0x2720, 0x61, ODT_REC, &ODObjs.o_2720_prot, NULL},
    {0x2730, 0x03, ODT_REC, &ODObjs.o_2730_canopen, NULL},
    {0x2740, 0x03, ODT_REC, &ODObjs.o_2740_storage, NULL},
    {0x2750, 0x04, ODT_REC, &ODObjs.o_2750_settings, NULL},
    {0x2760, 0x2b, ODT_REC, &ODObjs.o_2760_event_log, NULL},
    {0x2770, 0x26, ODT_REC, &ODObjs.o_2770_oscope, NULL},
