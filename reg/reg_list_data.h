...
REG(REG_ID_MEAS_CELL_UA, cell_U.out_A, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_MEAS_CELL_UB, cell_U.out_B, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_MEAS_CELL_UC, cell_U.out_C, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
...
REG(REG_ID_MODEL_STATOR_IA, lrm.out_stator_Iab, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_I_NOM)
REG(REG_ID_MODEL_STATOR_IB, lrm.out_stator_Ibc, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_I_NOM)
REG(REG_ID_MODEL_STATOR_IC, lrm.out_stator_Ica, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_I_NOM)
...
REG(REG_ID_MODEL_MOTOR_M, lrm.out_M, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_MODEL_MOTOR_W, lrm.out_w, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
...
REG(REG_ID_LINE_FREQ_UA, zcd_Ua.out_freq, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UA_FILTER_T, filter_freq_Ua.p_T, REG_TYPE_IQ24, REG_FLAG_CONF, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UA_FILT, filter_freq_Ua.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UB, zcd_Ub.out_freq, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UB_FILTER_T, filter_freq_Ub.p_T, REG_TYPE_IQ24, REG_FLAG_CONF, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UB_FILT, filter_freq_Ub.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UC, zcd_Uc.out_freq, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UC_FILTER_T, filter_freq_Uc.p_T, REG_TYPE_IQ24, REG_FLAG_CONF, REG_ID_NONE)
REG(REG_ID_LINE_FREQ_UC_FILT, filter_freq_Uc.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)

REG(REG_ID_RMS_UA, rms_Ua.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_RMS_UB, rms_Ub.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_RMS_UC, rms_Uc.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)

REG(REG_ID_MEAN_IARM, mean_Iarm.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_MEAN_IARM_FILTER_T, filter_mean_Iarm.p_T, REG_TYPE_IQ24, REG_FLAG_CONF, REG_ID_NONE)
REG(REG_ID_MEAN_IARM_FILT, filter_mean_Iarm.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_MEAN_UARM, mean_Uarm.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
REG(REG_ID_MEAN_UARM_FILTER_T, filter_mean_Uarm.p_T, REG_TYPE_IQ24, REG_FLAG_CONF, REG_ID_NONE)
REG(REG_ID_MEAN_UARM_FILT, filter_mean_Uarm.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_NONE)
