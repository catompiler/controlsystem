...
REG(REG_ID_MEAS_CELL_PWR_U, mux_cell_pwr_ui.out_U, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_MEAS_CELL_PWR_I, mux_cell_pwr_ui.out_I, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_I_NOM)
