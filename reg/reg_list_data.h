...
REG(REG_ID_MEAS_CELL_UA_LINE, cell_U_line.out_A, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_MEAS_CELL_UB_LINE, cell_U_line.out_B, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_MEAS_CELL_UC_LINE, cell_U_line.out_C, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
...
REG(REG_ID_RMS_CELL_UA_LINE, rms_cell_Ua_line.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_RMS_CELL_UB_LINE, rms_cell_Ub_line.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
REG(REG_ID_RMS_CELL_UC_LINE, rms_cell_Uc_line.out_value, REG_TYPE_IQ24, REG_FLAG_NONE, REG_ID_MOTOR_S_U_NOM)
