 ...
 * Сетевое напряжение.
 */
#define ADC_MODEL_MAINS_U_ABC 0 // 0 - ABC, 1 - ACB.
...
#define ADC_MODEL_MAINS_U_AMPL (141.42)
#define ADC_MODEL_MAINS_U_GAIN (IQ24(ADC_MODEL_MAINS_U_GAIN_F))
#define ADC_MODEL_MAINS_U_AMPL_RAW ((int32_t)(1.0 / ADC_MODEL_MAINS_U_GAIN_F * ADC_MODEL_MAINS_U_AMPL))
