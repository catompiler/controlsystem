...
/**
                                        ...
                                        '                  '
+---------------------------------+     ' +--------------+ '
| mot_pot_manual_curr_ref.r_value | --> ' |  in_value0   | '
+---------------------------------+     ' +--------------+ '
+---------------------------------+     ' +--------------+ '
|                0                | --> ' |  in_value1   | '
+---------------------------------+     ' +--------------+ '
...
+---------------------------------+     ' +--------------+ '
                                        ' +--------------+ '     +----------------------------------+
                                        ' |  out_value   | ' --> | lim_field_regs_curr_ref.in_value |
                                        ' +--------------+ '     +----------------------------------+
                                        '                  '
                                        + - - - - - - - - -+
 */
...
/**
                                 ...
                                 '                           '
+--------------------------+     ' +-----------------------+ '
| mux_field_regs.out_value | --> ' |       in_value        | '
+--------------------------+     ' +-----------------------+ '
                                 ' +-----------------------+ '     +--------------------------+
                                 ' |       out_value       | ' --> | mux_curr_ref.in_value[3] |
                                 ' +-----------------------+ '     +--------------------------+
                                 '                           '
                                 +- - - - - - - - - - - - - -+
 */
...
/**
                                            ...
                                            '                       '
+-------------------------------------+     ' +-------------------+ '
|   parameter - field force current   | --> ' |     in_value0     | '
+-------------------------------------+     ' +-------------------+ '
+-------------------------------------+     ' +-------------------+ '
| lim_field_regs_curr_ref.p_max_value | --> ' |     in_value1     | '
+-------------------------------------+     ' +-------------------+ '
                                            ' +-------------------+ '     +--------------------------+
                                            ' |     out_value     | ' --> | mux_curr_ref.in_value[2] |
                                            ' +-------------------+ '     +--------------------------+
                                            '                       '
                                            + - - - - - - - - - - - +
 */
...
+-----------------------------------+     ' +------------+ '
+-----------------------------------+     ' +------------+ '
|    mot_pot_field_test.r_value     | --> ' | in_value1  | '
+-----------------------------------+     ' +------------+ '
+-----------------------------------+     ' +------------+ '
|   mux_field_force_ref.out_value   | --> ' | in_value2  | '
+-----------------------------------+     ' +------------+ '
+-----------------------------------+     ' +------------+ '
| lim_field_regs_curr_ref.out_value | --> ' | in_value3  | '
+-----------------------------------+     ' +------------+ '
                                          ' +------------+ '     +--------------+
                                          ' | out_value  | ' --> | pid_i.in_ref |
                                          ' +------------+ '     +--------------+
                                          '                '
                                          + - - - - - - - -+
 */
...
/**
                               ...
                               '               '
+------------------------+     ' +-----------+ '
| mux_curr_ref.out_value | --> ' |  in_ref   | '
+------------------------+     ' +-----------+ '
+------------------------+     ' +-----------+ '
|  mean_Iarm.out_value   | --> ' |  in_fbk   | '
+------------------------+     ' +-----------+ '
                               ' +-----------+ '     +-----------------------+
                               ' | out_value | ' --> | ph3c.in_control_value |
                               ' +-----------+ '     +-----------------------+
                               '               '
                               +- - - - - - - -+
 */
