...
def gen_sin_table():
    ...
    print("#define IQ15_SIN_TABLE_SIZE %u\n" % (table_size));
    print("//! Таблица значений синуса.");
    print("__attribute__((aligned(4)))");
    print("static const int32_t iq15_sin_table[IQ15_SIN_TABLE_SIZE] = {\n    ", end='');
...
def main():
    print("#ifndef IQ15_SIN_TABLE_H");
    print("#define IQ15_SIN_TABLE_H");
    print("\n#include <stdint.h>\n\n");
