#ifndef TEST_IQ15_CORDIC_H
#define TEST_IQ15_CORDIC_H
...
static void test_iq15_cordic_atan2_pu(void)
{
    ...
    //printf("float atan2 vs iq15 atan2 pu\n");
...
static void test_iq15_cordic_atan2(void)
{
    float f_val, fx, fy, fq_val;
    iq15_t q_val;
...
static void test_iq15_cordic_hyp(void)
{
    float f_val, fx, fy, fq_val;
    iq15_t q_val;
    ...
    while(ac < 359){
        ...
        iq15_cordic_atan2_hyp_pu(IQ15(fx), IQ15(fy), NULL, &q_val);
        fq_val = (float)q_val / IQ15_BASE;
...
static void test_iq15_cordic_sin_pu(void)
{
    float f_val, fq_val;
    iq15_t q_val;
...
static void test_iq15_cordic_cos_pu(void)
{
    float f_val, fq_val;
    iq15_t q_val;
...
static void test_iq15_cordic_sin(void)
{
    float f_val, fq_val;
    iq15_t q_val;
    ...
    while(ac < 359){
        ...
        f_val = sinf(a);
        iq15_cordic_sincos(IQ15(a), &q_val, NULL);
        fq_val = (float)q_val / IQ15_BASE;
...
static void test_iq15_cordic_cos(void)
{
    float f_val, fq_val;
    iq15_t q_val;
    ...
    while(ac < 359){
        ...
        f_val = cosf(a);
        iq15_cordic_sincos(IQ15(a), NULL, &q_val);
        fq_val = (float)q_val / IQ15_BASE;
...
static CU_ErrorCode test_iq15_cordic(void)
{
    CU_pSuite suite = CU_add_suite("IQ15 cordic", NULL, NULL);
    if(suite == NULL) return CU_get_error();

    if(CU_add_test(suite, "iq15_cordic_atan2_pu", test_iq15_cordic_atan2_pu) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_atan2", test_iq15_cordic_atan2) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_hyp", test_iq15_cordic_hyp) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_sin_pu", test_iq15_cordic_sin_pu) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_cos_pu", test_iq15_cordic_cos_pu) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_sin", test_iq15_cordic_sin) == NULL) return CU_get_error();
    if(CU_add_test(suite, "iq15_cordic_cos", test_iq15_cordic_cos) == NULL) return CU_get_error();
